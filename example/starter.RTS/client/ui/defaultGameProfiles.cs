...
new GuiControlProfile (LobbyHudMessageProfile)
{
   fontType = "Arial";
   fontSize = 16;
   ...
   fontColors[1] = "4 235 105";   // client join/drop, tournament mode
   fontColors[2] = "219 200 128"; // gameplay, admin/voting, pack/deployable
   fontColors[3] = "237 230 245";   // team chat, spam protection message, client tasks
   fontColors[4] = "235 185 167";  // global chat
   fontColors[5] = "200 200 50 200";  // used in single player game
