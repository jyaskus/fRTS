...
$RemapCount++;
$RemapName[$RemapCount] = "Toggle Stats Dialog";   // JY -- stats dialog GUI
	...
	else if ( strstr( %device, "joystick" ) != -1 )
	{
	   ...
	   { 
         ...
         if ( %pos != -1 )
         {
            ...
            error( "Unsupported Joystick input object passed to getDisplayMapName! (" @ %action @ ")" );
      }
	}
...
{
	warn( "** onInputEvent called - device = " @ %device @ ", action = " @ %action @ " **" );
