...
datablock AudioProfile(UnitDeathCry)
{
   filename = "~/data/sound/orc_death.ogg";
   description = "AudioDefault3d";
   preload=true;
};
datablock AudioProfile(UnitPainCry)
{
   filename = "~/data/sound/orc_pain.ogg";
   description = "AudioDefault3d";
   preload=true;
};
datablock AudioProfile(UnitAttackSound)
{
...
datablock AudioProfile(buildSound)
{
   filename = "~/data/sound/construction.ogg";
   description = "AudioDefault3d";
   preload=true;
};
