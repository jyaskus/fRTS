...
datablock ParticleData(HighLavaShooter01)
{
   ...
   lifetimeVarianceMS   = 4000; // Must not be greater than lifetimeMS //
...
datablock ParticleData(HighLavaShooter03)
{
   ...
   lifetimeVarianceMS   = 3000; // Must not be greater than lifetimeMS //
   useInvAlpha = false; // False = Additive I think //
   spinRandomMin = -100.0; // Particle's Min spin speed -10,000 to 10,000 //
   spinRandomMax = 100.0; // Particle's Max spin speed -10,000 to 10,000 //
...
datablock ParticleEmitterData(HighLavaShooterEmitter)
{
   ...
   ejectionVelocity = 40.0; // Initial velocity a particle is emitted 0-655 //
   velocityVariance = 60.0; //  Must not be neg. or > ejectionVelocity 0-163//

   ejectionOffset   = 0.0; // distance of offset from emitter 0-655 //

   thetaMin         = 180.0; // Ejection angle relative to the x-axis 0-180//
...
datablock ParticleEmitterData(LavaShooterEmitter)
{
   ...
   ejectionVelocity = 25.0; // Initial velocity a particle is emitted 0-655 //
   velocityVariance = 135.0; //  Must not be neg. or > ejectionVelocity 0-163//
...
datablock ParticleEmitterData(LavaExplosionEmitter)
{
   ...
   ejectionVelocity = 10.0; // Initial velocity a particle is emitted 0-655 //
   velocityVariance = 15.0; //  Must not be neg. or > ejectionVelocity 0-163//
...
datablock ParticleEmitterData(SpatteringLavaEmitter)
{
   ...
   thetaMin         = 180.0; // Ejection angle relative to the x-axis 0-180//
   thetaMax         = 25.0; // Ejection angle relative to the x-axis 0-180//
...
datablock ParticleEmitterData(VolcanoSmokeLargeEmitter)
{
   ...
   thetaMin         = 90.0; // Ejection angle relative to the x-axis 0-180//
   thetaMax         = 25.0; // Ejection angle relative to the x-axis 0-180//
...
datablock ParticleEmitterData(LavaSmokeSmallEmitter)
{
   ...
   ejectionVelocity = 0.5; // Initial velocity a particle is emitted 0-655 //
   velocityVariance = 1.0; //  Must not be neg. or > ejectionVelocity 0-163//
