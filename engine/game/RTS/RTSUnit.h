...
//-----------------------------------------------------------------------------
// bug fix applied Sept 22, 2007 from Stephen Zepp forum post *23223
...
//-----------------------Begin Bug Fix: http://www.garagegames.com/mg/forums/result.thread.php?qt=23223
   StringTableEntry mRTSUnitTypeName;
//-----------------------End Bug Fix
   S32 mBaseDamage;
   S32 mAttackDelay;
   S32 mDamagePlus;
...
//-----------------------Begin Bug Fix: http://www.garagegames.com/mg/forums/result.thread.php?qt=23223
   const char *getUnitTypeName() const {return dynamic_cast<RTSUnitData*>(mDataBlock)->mRTSUnitTypeName; }
//-----------------------End Bug Fix 
