...
struct TerrainRender
{
   ...
   static void emitTerrChunk(SquareStackNode *n, F32 squareDistance, U32 lightMask, SelectionField selectionMask, bool farClip, bool useDetails, bool useBumps);
   ...
   static SelectionField TestSquareSelections(GridSquare *sq, S32 level, Point2I sqPos, SelectionField selectionMask);
